...
for (i in 1:nb_etape4){
png(str_glue("../figs/Hal-o-metre_{N+1001+i}.png"), 
    width = 400, height = 480)
...
## Animation ####
system("convert -delay 5 ../figs/*.png -loop 1 ../Etape3_shiny/www/hal-o-meterb.gif")
system("convert -delay 5 ../figs/*.png  ../Etape3_shiny/www/hal-o-meterloop.gif")
